...
OBJECTFILES= \
	${OBJECTDIR}/src/App.o \
	${OBJECTDIR}/src/ControllerTest.o \
...
${OBJECTDIR}/src/ControllerTest.o: src/ControllerTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ControllerTest.o src/ControllerTest.cpp
...
${OBJECTDIR}/src/FileManager.o: src/FileManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileManager.o src/FileManager.cpp
...
${OBJECTDIR}/src/Stringify.o: src/Stringify.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Stringify.o src/Stringify.cpp
...
${OBJECTDIR}/src/TextureBank.o: src/TextureBank.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TextureBank.o src/TextureBank.cpp
